...
Defines how the desktop application builds and bundles external resources (NestJS server and frontend) into the `resources/` directory for Electron packaging. This capability covers the build scripts, copy logic, environment injection, and gitignore conventions that make the app self-contained.
