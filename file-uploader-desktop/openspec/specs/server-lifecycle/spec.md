...
Defines how the Electron main process manages the NestJS server subprocess at runtime: single-instance enforcement, database migration, subprocess forking with environment injection, health-check polling, error handling, and graceful shutdown. This capability covers the full lifecycle from app launch to quit.
